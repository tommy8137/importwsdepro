...
const AccessoriesPrice = (props) => {
  const {
    ...
    activeProductType,
    // actions
    getCableFfcAccessoriesPrice,
    putCableFfcAccessoriesPrice,
    setProductType,
  } = props;
  ...
  const extendsCSDBPorps = {
    location,
    setProductType,
    mainTable: accessoriesPrice,
    initialSortInfo: { dataIndex: '', sortOrder: 'ascend' },
    initialFilterInfo: { keyword: '', dataIndex: 'spec' },
    mainTableUpdater: putCableFfcAccessoriesPrice,
  };
  const {
    // For table
    isEditMode,
...
const mapStateToProps = (state) => {
  return {
    accessoriesPrice: state.cableffcCleanSheet.accessoriesPrice.accessoriesPrice,
    date: state.cableffcCleanSheet.accessoriesPrice.date,
    activeProductType: state.dataBase.common.activeProductType,
  };
};

const mapDispatchToProps = {
  getCableFfcAccessoriesPrice: CableFfcCleanSheetActions.getCableFfcAccessoriesPrice,
  putCableFfcAccessoriesPrice: CableFfcCleanSheetActions.putCableFfcAccessoriesPrice,
