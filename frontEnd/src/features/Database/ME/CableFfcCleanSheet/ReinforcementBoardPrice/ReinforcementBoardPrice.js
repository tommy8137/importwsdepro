...
const ReinforcementBoardPrice = (props) => {
  const {
    location,
    // state
    ...
    activeProductType,
    // actions
    getCableFfcReinforcementBoardPrice,
    putCableFfcReinforcementBoardPrice,
    setProductType,
  } = props;
  ...
  const extendsCSDBPorps = {
    location,
    setProductType,
    mainTable: reinforcementBoardPrice,
    initialSortInfo: { dataIndex: '', sortOrder: 'ascend' },
    initialFilterInfo: { keyword: '', dataIndex: 'spec' },
    mainTableUpdater: putCableFfcReinforcementBoardPrice,
  };
  const {
    // For table
    isEditMode,
...
const mapStateToProps = (state) => {
  return {
    reinforcementBoardPrice: state.cableffcCleanSheet.reinforcementBoardPrice.reinforcementBoardPrice,
    date: state.cableffcCleanSheet.reinforcementBoardPrice.date,
    activeProductType: state.dataBase.common.activeProductType,
  };
};

const mapDispatchToProps = {
  getCableFfcReinforcementBoardPrice: CableFfcCleanSheetActions.getCableFfcReinforcementBoardPrice,
  putCableFfcReinforcementBoardPrice: CableFfcCleanSheetActions.putCableFfcReinforcementBoardPrice,
