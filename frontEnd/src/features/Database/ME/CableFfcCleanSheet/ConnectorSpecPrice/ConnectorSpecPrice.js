...
const ConnectorSpecPrice = (props) => {
  const {
    location,
    // state
    connectorSpecPrice,
    ...
    activeProductType,
    // actions
    getCableFfcConnectorSpecPrice,
    putCableFfcConnectorSpecPrice,
    setProductType,
  } = props;
  ...
  const extendsCSDBPorps = {
    location,
    setProductType,
    mainTable: connectorSpecPrice,
    initialSortInfo: { dataIndex: '', sortOrder: 'ascend' },
    initialFilterInfo: { keyword: '', dataIndex: 'spec' },
    mainTableUpdater: putCableFfcConnectorSpecPrice,
  };
  const {
    // For table
    isEditMode,
...
const mapStateToProps = (state) => {
  return {
    connectorSpecPrice: state.cableffcCleanSheet.connectorSpecPrice.connectorSpecPrice,
    date: state.cableffcCleanSheet.connectorSpecPrice.date,
    activeProductType: state.dataBase.common.activeProductType,
  };
};

const mapDispatchToProps = {
  getCableFfcConnectorSpecPrice: CableFfcCleanSheetActions.getCableFfcConnectorSpecPrice,
  putCableFfcConnectorSpecPrice: CableFfcCleanSheetActions.putCableFfcConnectorSpecPrice,
