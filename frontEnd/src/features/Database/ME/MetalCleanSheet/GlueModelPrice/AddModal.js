  ...
  return (
    <ModalWrap isOpen={isOpen}>
        ...
        <div className="body-wrap">
          <Field.Row>
            <Field.Field width="100%">
              <Field.Label title="膠水類型" isRequired />
              <Field.Input
          ...
          <Field.Row>
            <Field.Field width="100%">
              <Field.Label title="密度" isRequired />
              <Field.Input
      ...
      <Modal.ModalFooter>
        ...
        <Button color="black" onClick={() => handleAddItem(glueType, density, price)} disabled={!(glueType && density && price)}>Save</Button>
      </Modal.ModalFooter>
    </ModalWrap>
  );
};
