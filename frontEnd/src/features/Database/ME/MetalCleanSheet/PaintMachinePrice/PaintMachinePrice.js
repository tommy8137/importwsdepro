...
const mapStateToProps = (state) => {
  return {
    paintMachinePriceList: state.metalCleanSheet.paintMachinePrice.paintMachinePriceList,
    date: state.metalCleanSheet.paintMachinePrice.date,
  };
};

const mapDispatchToProps = {
  getPaintMachinePriceList: MetalCleanSheetActions.getPaintMachinePriceList,
  updatePaintMachinePrice: MetalCleanSheetActions.updatePaintMachinePrice,
