...
const PaintGroupList = (props) => {
  ...
  // 路徑設定
  const routerList = [
    { name: '噴漆顏色及類型清單', routerName: '/g/database/metal/PaintTypeList' },
  ];
...
const mapStateToProps = (state) => {
  ...
  return {
    paintGroupList: state.metalCleanSheet.paintGroup.paintGroupList,
  };
};

const mapDispatchToProps = {
  getPaintGroupList: MetalCleanSheetActions.getPaintGroupList,
