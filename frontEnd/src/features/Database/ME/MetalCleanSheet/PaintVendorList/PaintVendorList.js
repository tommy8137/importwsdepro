...
const mapStateToProps = (state) => {
  return {
    paintVendorList: state.metalCleanSheet.paintVendorList.paintVendor,
  };
};

const mapDispatchToProps = {
  getPaintVendorList: MetalCleanSheetActions.getPaintVendorList,
  updatePaintVendorList: MetalCleanSheetActions.updatePaintVendorList,
