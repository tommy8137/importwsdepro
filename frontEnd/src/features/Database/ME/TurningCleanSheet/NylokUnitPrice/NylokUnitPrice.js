...
const NylokUnitPrice = props => {
  const { getNylokUnitPrice, putNylokUnitPrice, date, nylokUnitPriceList } = props;
  ...
  const extendsCSDBPorps = {
    mainTable: nylokUnitPriceList,
    initialSortInfo: { dataIndex: '', sortOrder: 'ascend' },
    initialFilterInfo: { keyword: '', dataIndex: ['material', 'color', 'diameter', 'length'] },
  };
...
const mapStateToProps = state => {
  return {
    nylokUnitPriceList: state.turningCleanSheet.nylokUnitPrice.nylokPrice,
    date: state.turningCleanSheet.nylokUnitPrice.date,
  };
};

const mapDispatchToProps = {
  getNylokUnitPrice: TurningCleanSheetActions.getNylokUnitPrice,
  putNylokUnitPrice: TurningCleanSheetActions.putNylokUnitPrice,
};
