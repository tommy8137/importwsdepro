...
const ElectroplatingUnitPrice = props => {
  const { getElectroplatingUnitPrice, putElectroplatingUnitPrice, date, electroplatingUnitPriceList } = props;
  ...
  const extendsCSDBPorps = {
    mainTable: electroplatingUnitPriceList,
  ...
  const handleSave = () => {
    ...
    setEditMode(false);
    putElectroplatingUnitPrice(data);
  };
...
const mapStateToProps = state => {
  return {
    electroplatingUnitPriceList: state.turningCleanSheet.electroplatingUnitPrice.platingPrice,
    date: state.turningCleanSheet.electroplatingUnitPrice.date,
  };
};

const mapDispatchToProps = {
  getElectroplatingUnitPrice: TurningCleanSheetActions.getElectroplatingUnitPrice,
  putElectroplatingUnitPrice: TurningCleanSheetActions.putElectroplatingUnitPrice,
};
