...
const mapStateToProps = (state) => {
  return {
    laborUnitPriceAndWorkSheetList: state.plasticCleanSheet.laborUnitPriceAndWorkSheet.laborUnitPriceAndWorkSheetList,
    date: state.plasticCleanSheet.laborUnitPriceAndWorkSheet.date,
  };
};

const mapDispatchToProps = {
  getLaborUnitPriceAndWorkSheetList: PlasticCleanSheetActions.getLaborUnitPriceAndWorkSheetList,
  updateLaborUnitPriceAndWorkSheetList: PlasticCleanSheetActions.updateLaborUnitPriceAndWorkSheetList,
