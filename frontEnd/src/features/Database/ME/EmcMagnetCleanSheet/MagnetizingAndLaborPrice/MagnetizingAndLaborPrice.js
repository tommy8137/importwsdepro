...
const MagnetizingAndLaborPrice = props => {
  const {
    date,
    magnetizingAndLaborPriceList,
    getMagnetizingAndLaborPrice,
    updateMagnetizingAndLaborPrice,
  } = props;
  ...
  const extendsCSDBPorps = {
    mainTable: magnetizingAndLaborPriceList,
  ...
  const handleSave = () => {
    ...
    setEditMode(false);
    updateMagnetizingAndLaborPrice(data);
  };
...
const mapStateToProps = state => {
  return {
    magnetizingAndLaborPriceList: state.emcMagnetCleanSheet.magnetizingAndLaborPrice.magnetizingAndLaborPriceList,
    date: state.emcMagnetCleanSheet.magnetizingAndLaborPrice.date,
  };
};

const mapDispatchToProps = {
  getMagnetizingAndLaborPrice: EmcMagnetCleanSheetActions.getMagnetizingAndLaborPrice,
  updateMagnetizingAndLaborPrice: EmcMagnetCleanSheetActions.updateMagnetizingAndLaborPrice,
};
