...
const mapStateToProps = state => {
  return {
    petPriceList: state.thermalGraphiteCleanSheet.petPrice.petPriceList,
    date: state.thermalGraphiteCleanSheet.petPrice.date,
  };
};

const mapDispatchToProps = {
  getPetPrice: ThermalGraphiteCleanSheetActions.getPetPrice,
  updatePetPrice: ThermalGraphiteCleanSheetActions.updatePetPrice,
};
