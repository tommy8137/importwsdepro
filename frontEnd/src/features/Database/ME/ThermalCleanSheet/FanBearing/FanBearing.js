    ...
    <InnerContainer>
      <div className="inner-content">
        <div className="content-header">
          <div className="title">Fan 軸承差異 清單</div>
        </div>
...
const mapStateToProps = (state) => {
  return {
    fanBearingList: state.thermalCleanSheet.fanBearing.fanBearingList,
  };
};

const mapDispatchToProps = {
  getFanBearing: ThermalCleanSheetActions.getFanBearing,
};
