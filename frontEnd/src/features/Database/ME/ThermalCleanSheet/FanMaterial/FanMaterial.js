    ...
    <InnerContainer>
      <div className="inner-content">
        <div className="content-header">
          <div className="title">Fan 扇葉材料 清單</div>
        </div>
...
const mapStateToProps = (state) => {
  return {
    fanMaterialList: state.thermalCleanSheet.fanMaterial.fanMaterialList,
  };
};

const mapDispatchToProps = {
  getFanMaterial: ThermalCleanSheetActions.getFanMaterial,
};
