    ...
    <InnerContainer>
      <div className="inner-content">
        <div className="content-header">
          <div className="title">Die Cut Parameters</div>
        </div>
        {/* 左邊 */}
...
const mapStateToProps = (state) => {
  return {
    parameterList: state.diecutCleanSheet.parameter.parameterList,
    date: state.diecutCleanSheet.parameter.date,
  };
};

const mapDispatchToProps = {
  getDieCutParameters: DieCutCleanSheetActions.getDieCutParameters,
  updateDieCutParameters: DieCutCleanSheetActions.updateDieCutParameters,
