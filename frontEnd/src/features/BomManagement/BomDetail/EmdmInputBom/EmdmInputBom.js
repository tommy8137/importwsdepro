...
import EmdmBomTable from '../components/EmdmBomTable';
...
const EmdmInputBom = (props) => {
  const {
    isInputBomInfoOpen,
    bomData: {
      skuCost = [], projectName, emdmVersion, totalItems, skuDesc, unEditCount
    },
      ...
      <BomHead>
        ...
        <Collapse isOpen={isInputBomInfoOpen}>
          <div className="bom-info">
            ...
            <label>
              <span>eMDM Version</span>
              <p title={emdmVersion}>{emdmVersion}</p>
            </label>
            <label className="des">
...
const mapDispatchToProps = {
  ...
  deleteTemp: BomDetailActions.cancelEditMEBomTable,
  // FOR MODAL INFO
...
export default compose(
  ...
  checkingUserInfo(),
  checkingRbac([['View', 'allow', 'me_bom_projects']])
)(EmdmInputBom);
