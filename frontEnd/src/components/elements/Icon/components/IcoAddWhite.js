...
export default class IcoAddWhite extends Component {
  static propTypes = {};
  static defaultProps = {};
  constructor(props) {
    super(props);
    ...
    return (
      <svg viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <g id="Permission---GUI-Design" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g id="1-2_Setting_Permission_Role-Management_view" transform="translate(-1197.000000, -261.000000)" fill="#FFFFFF">
