...
INSERT INTO wiprocurement.rbac_user_role (emplid, role_name) 
    SELECT emplid, 'contactwindow' FROM wiprocurement.user AS ur 
    WHERE ur.is_superuser='true'
    AND NOT EXISTS(SELECT * FROM wiprocurement.rbac_user_role WHERE emplid = ur.emplid AND role_name='contactwindow');
...
INSERT INTO wiprocurement.rbac_user_role (emplid, role_name) 
    SELECT emplid, 'contactwindow' FROM wiprocurement.user AS ur 
    WHERE ur.is_contact_window='true'
    AND NOT EXISTS(SELECT * FROM wiprocurement.rbac_user_role WHERE emplid = ur.emplid AND role_name='contactwindow');
