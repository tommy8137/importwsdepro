...
ADD COLUMN IF NOT EXISTS alt_lowest_price numeric,
ADD COLUMN IF NOT EXISTS alt_lowest_partnumber varchar(20),
ADD COLUMN IF NOT EXISTS alt_manufacturer varchar(50),
ADD COLUMN IF NOT EXISTS alt_grouping json,
ADD COLUMN IF NOT EXISTS alt_other_info json;
