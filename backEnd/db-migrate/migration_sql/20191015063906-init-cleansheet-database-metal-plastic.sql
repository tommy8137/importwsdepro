...
DROP TABLE if exists formula.plastic_emi_site_group;
DROP TABLE if exists formula.plastic_emi_group;
DROP TABLE if exists formula.plastic_paint_vendor_type_color;
DROP TABLE if exists formula.plastic_paint_type_color_button_top;
...
DROP TABLE if exists formula.plastic_paint_button_top;
...
CREATE TABLE if not exists formula.material (
	...
	CONSTRAINT material_un UNIQUE (material_name),
...
CREATE TABLE if not exists formula.plastic_paint_button_top (
    id uuid not null DEFAULT uuid_generate_v1(),
    button_top_name varchar(200) not null,
    create_time timestamptz NOT NULL DEFAULT now(),
	disable_time timestamptz NULL,
	CONSTRAINT plastic_paint_button_top_pk PRIMARY KEY (id),
	CONSTRAINT plastic_paint_button_top_un UNIQUE (button_top_name)
);
...
CREATE TABLE if not exists formula.plastic_paint_type_color_button_top (
    id uuid not null DEFAULT uuid_generate_v1(),
    paint_type_color_id uuid not null,
    paint_button_top_id uuid not null,
    create_time timestamptz NOT NULL DEFAULT now(),
	disable_time timestamptz NULL,
	CONSTRAINT plastic_paint_type_color_button_top_pk PRIMARY KEY (id),
	CONSTRAINT plastic_paint_type_color_button_top_un UNIQUE (paint_type_color_id,paint_button_top_id),
	CONSTRAINT plastic_paint_type_color_button_top_fk FOREIGN KEY (paint_type_color_id) REFERENCES formula.plastic_paint_type_color(id),
	CONSTRAINT plastic_paint_type_color_button_top_fk1 FOREIGN KEY (paint_button_top_id) REFERENCES formula.plastic_paint_button_top(id)
);

CREATE TABLE if not exists formula.plastic_paint_vendor_type_color_button_top (
    id uuid not null DEFAULT uuid_generate_v1(),
    type_color_button_top_id uuid not null,
    paint_vendor_id uuid not null,
    create_time timestamptz NOT NULL DEFAULT now(),
	disable_time timestamptz NULL,
	CONSTRAINT plastic_paint_vendor_type_color_button_top_pk PRIMARY KEY (id),
	CONSTRAINT plastic_paint_vendor_type_color_button_top_un UNIQUE (type_color_button_top_id,paint_vendor_id),
	CONSTRAINT plastic_paint_vendor_type_color_button_top_fk FOREIGN KEY (type_color_button_top_id) REFERENCES formula.plastic_paint_type_color_button_top(id),
	CONSTRAINT plastic_paint_vendor_type_color_button_top_fk1 FOREIGN KEY (paint_vendor_id) REFERENCES formula.plastic_paint_vendor(id)
);

CREATE TABLE if not exists formula.plastic_emi_group (
	id uuid not null DEFAULT uuid_generate_v1(),
...
CREATE TABLE if not exists formula.plastic_emi_site_group (
	...
	CONSTRAINT plastic_emi_site_group_fk1 FOREIGN KEY (group_id) REFERENCES formula.plastic_emi_group(id)
);
...
CREATE TABLE if not exists formula.plastic_emi_sputtering_link (
	...
	CONSTRAINT plastic_emi_sputtering_link_fk FOREIGN KEY (group_id) REFERENCES formula.plastic_emi_group(id),
...
CREATE TABLE if not exists formula.plastic_grinding (
    ...
    lost_rate uuid not null DEFAULT uuid_generate_v1(),
...
CREATE TABLE if not exists formula.plastic_embed_nail (
    ...
    loss_rate uuid not null DEFAULT uuid_generate_v1(),
...
--init plastic material value
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_BPL1000') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='FR_PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 5.95, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_ML7681') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='FR_PC_Translucent')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 7.05, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_FXD9810') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='FR_PC_Diffusion_擴散')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 9.25, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_121R / 141R /123R-CC') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='Non_FR_PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.85, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Dupont_HTNFR55G50NHLWSF') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PA_50percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 10.05, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Dupont_HTN59G55LWSF') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PA1010_55percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 15, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_EXL1414') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 5.52, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_L-1225L') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.2, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_L-1225Y') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.2, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_L-1250Y') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.2, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_LN2520A') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_MN-4800') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_MN-3709EE') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_with_25percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.6, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_RCX7243') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 5.17, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'MEP_FPR3500') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_非透明')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6.25, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'MEP_FPL3500') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_非透明')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6.25, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_D151') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_10percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 7.9, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_GV-3510R') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_10percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY ER2102') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_10percent_GF_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.2, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'MEP_CP2015N2') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_15percent_CF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 15.85, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_DC0041PQ') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_20percent_CF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 11.32, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_DC0041PR') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_20percent_CF_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 11.62, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_D251') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_20percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 7.9, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_GV-3520R') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_20percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY GN2253F') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_25percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.85, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_BM5225Y') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_25percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.9, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_DN-5325B') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_25percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_DN-5325S') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_25percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.85, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_DN-5325SEF') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_25percent_Talc_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_RCM6224') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_25percent_Talc_with_35percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.38, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_GF9016') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_30percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY GN2303F') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_30percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.9, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_D351') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_30percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 7, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_GXV-3530UH') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_30percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 5.8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_GF9012MF') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_35percent_GF_with_5percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 5.9, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_GF9018') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_40percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 5.7, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY GN2403FT') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_40percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 5.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_D451') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_40percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 8.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_D452') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_40percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 8.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_GN-3540RI') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_40percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 7.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY ER2403F') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_40percent_GF_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_GXV-3545WI') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_45percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_GF9020') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_50percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 7.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY GN2503F') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_50percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6.75, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_D551') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_50percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 8.73, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_GXV-3550WI') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_50percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 8.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_M4004GR') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_50percent_GF_Recycle')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.05, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY ER2503F') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_50percent_GF_with_20percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 7.45, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_D551RC') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_50percent_GF_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 8.73, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_FR3002') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_FR3008') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.25, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_FR3040') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.7, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY GN5001RFD') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'MEP_MB1800') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_CX2244ME') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 9.95, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_CX7240') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 5.9, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_CY6120') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.1, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN-7000A') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.55, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN-7690A') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.29, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LOTTE_NH-1021') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.7, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LOTTE_NH-1015V') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_FR630GR') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.7, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY ER5001RFA') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_RCY6214') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_with_35percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.13, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN 7050') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_高光澤高流動')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 5.8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN 7050Y') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_高光澤高流動')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY GN5121RF') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_12percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'MEP_TMB1412') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_12percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_FR3021') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.1, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY GN5151RFA') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.1, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'MEP_TMB1615') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_C7230P') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.9, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN-3715B') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.3, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN-3715BW') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.3, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN-3715BX') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.55, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN-3740B') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LOTTE_NH-1150HH') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.3, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_FR3021BBS910') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc_UVS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN-3715BZ') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc_UVS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.15, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN 3745BEC') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc_with_15percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.56, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_FR3021GR') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.6, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY ER5151RFL') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.4, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_RCM6123') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.1, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN 3745BEF') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_15percent_Talc_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.4, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_FR3023') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_23percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.6, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_FR3025') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_25percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.4, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY GN5254FD') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_25percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.4, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY ER5254F') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_25percent_Talc_with_30percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_FR3025R35') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_25percent_Talc_with_35percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.2, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'MEP_MB1700') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_3percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_FR3020') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_5percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY GN5101RF') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_5percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.35, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_C7210A') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_5percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.9, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_C7410') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_5percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.55, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN-3713B') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_5percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.45, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN-3713BX') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_5percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.55, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN-7100F') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_5percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 3.1, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_TN-7200B') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_5percent_Talc_UVS')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.15, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_RCM6134') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_5percent_Talc_with_35percent_PCR')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.09, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_CM6140') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_8percent_Talc')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.1, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_LUPOY SG-5009FA') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_ABS_PMMA')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'MEP_BCB992') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC_GF_CF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'MEP_7025A OAT223') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PC紅外線透過型')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 9.75, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'MEP_F20-03') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='POM')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 2.8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Dupont_Delrin100') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='POM')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.85, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Dupont_HTNFE170016') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PPA_55percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 10.05, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Dupont_HTNFE170023') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PPA_60percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 12, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Toray_A305M45B') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PPS_45percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 9.8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Toray_A595H')AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PPS_50percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 10.2, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'LG_EGP2500') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PPS_50percent_GF')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 7, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Toray_A695H')AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='PPS_50percent_GF_MD')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 9.85, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Dupont_Hytrel_3046') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPEE')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 9.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Dupont_Hytrel_3078') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPEE')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 9.2, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Dupont_Hytrel_4056') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPEE')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 7.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Dupont_Hytrel_RS30F7') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPEE')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 15.3, 'number', 'material', now());
 ...
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_UDS70AU') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPU')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 10.8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_IT85AU') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPU')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 14.2, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_8785A') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPU')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6.2, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_1070AU') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPU')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 12.3, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_5377A') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPU')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 14.8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Covestro_1065AU') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPU')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6.7, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Huntsman_AVALON 85AE') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPU')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Huntsman_AVALON 80AE') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPU')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6.1, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Huntsman_AVALON 75AE') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPU')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Huntsman_AVALON 65AB') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='TPU')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6.8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Sabic_LNP Lubriloy D20001') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='Wearable_PC_耐磨')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 12.2, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Dupont_HTR8813') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='防火_TPEE')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 16, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Dupont_HTR8837') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='防火_TPEE')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 11.5, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_MN-3600H') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='防火高流動_PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.7, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_L-1225Z100') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='耐候_PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 4.4, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'MEP_EFD8000')AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='擴散級_PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 8, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'MEP_EFD3304U') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='擴散級_PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 6, 'number', 'material', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.material WHERE (material_name = 'Teijin_ML-1103') AND (material_spec_id = (SELECT id FROM formula.material_spec WHERE (material_spec_name='擴散級_PC')))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), 8, 'number', 'material', now());
...
INSERT INTO formula.plastic_paint_button_top
(id, button_top_name, create_time, disable_time)
...
INSERT INTO formula.plastic_paint_type_color_button_top
(id, paint_type_color_id, paint_button_top_id, create_time, disable_time)
VALUES(uuid_generate_v1(), (select id from formula.plastic_paint_type_color where paint_type_id =(select id from formula.plastic_paint_type where type_name = 'PU_painting')), (select id from formula.plastic_paint_button_top where button_top_name = '底漆' ), now(), null);



INSERT INTO formula.plastic_paint_type_color_button_top
(id, paint_type_color_id, paint_button_top_id, create_time, disable_time)
VALUES(uuid_generate_v1(), (select id from formula.plastic_paint_type_color where paint_type_id =(select id from formula.plastic_paint_type where type_name = 'Rubber_painting')), (select id from formula.plastic_paint_button_top where button_top_name = '底漆' ), now(), null);


INSERT INTO formula.plastic_paint_type_color_button_top
(id, paint_type_color_id, paint_button_top_id, create_time, disable_time)
VALUES(uuid_generate_v1(), (select id from formula.plastic_paint_type_color where paint_type_id =(select id from formula.plastic_paint_type where type_name = 'NCVM')), (select id from formula.plastic_paint_button_top where button_top_name = '底漆' ), now(), null);

INSERT INTO formula.plastic_paint_type_color_button_top
(id, paint_type_color_id, paint_button_top_id, create_time, disable_time)
VALUES(uuid_generate_v1(), (select id from formula.plastic_paint_type_color where paint_type_id =(select id from formula.plastic_paint_type where type_name = 'PU_painting')), (select id from formula.plastic_paint_button_top where button_top_name = '面漆' ), now(), null);


INSERT INTO formula.plastic_paint_type_color_button_top
(id, paint_type_color_id, paint_button_top_id, create_time, disable_time)
VALUES(uuid_generate_v1(), (select id from formula.plastic_paint_type_color where paint_type_id =(select id from formula.plastic_paint_type where type_name = 'Rubber_painting')), (select id from formula.plastic_paint_button_top where button_top_name = '面漆' ), now(), null);


INSERT INTO formula.plastic_paint_type_color_button_top
(id, paint_type_color_id, paint_button_top_id, create_time, disable_time)
VALUES(uuid_generate_v1(), (select id from formula.plastic_paint_type_color where paint_type_id =(select id from formula.plastic_paint_type where type_name = 'NCVM')), (select id from formula.plastic_paint_button_top where button_top_name = '面漆' ), now(), null);



--
INSERT INTO formula.plastic_paint_type_color_button_top (id, paint_type_color_id, paint_button_top_id, create_time, disable_time)
VALUES(uuid_generate_v1(), (select id from formula.plastic_paint_type_color where paint_color_id = (select id from formula.plastic_paint_color where color_name = '一般或霧面(黑/灰/銀)') and paint_type_id = (select id from formula.plastic_paint_type where type_name = 'UV_painting')), (select id  from formula.plastic_paint_button_top where button_top_name ='面漆') , now(), null);
INSERT INTO formula.plastic_paint_type_color_button_top (id, paint_type_color_id, paint_button_top_id, create_time, disable_time)
VALUES(uuid_generate_v1(), (select id from formula.plastic_paint_type_color where paint_color_id = (select id from formula.plastic_paint_color where color_name = '彩色或高光(金/紅/藍)') and paint_type_id = (select id from formula.plastic_paint_type where type_name = 'UV_painting')), (select id  from formula.plastic_paint_button_top where button_top_name ='面漆') , now(), null);
INSERT INTO formula.plastic_paint_type_color_button_top (id, paint_type_color_id, paint_button_top_id, create_time, disable_time)
VALUES(uuid_generate_v1(), (select id from formula.plastic_paint_type_color where paint_color_id = (select id from formula.plastic_paint_color where color_name = 'Soft Touch') and paint_type_id = (select id from formula.plastic_paint_type where type_name = 'UV_painting')), (select id  from formula.plastic_paint_button_top where button_top_name ='面漆') , now(), null);
INSERT INTO formula.plastic_paint_type_color_button_top (paint_button_top_id, paint_type_color_id, create_time, disable_time) VALUES ( (SELECT id FROM formula.plastic_paint_button_top WHERE (button_top_name = '面漆')), (SELECT id FROM formula.plastic_paint_type_color WHERE (paint_color_id = (SELECT id FROM formula.plastic_paint_color WHERE (color_name='N/A'))) AND (paint_type_id = (SELECT id FROM formula.plastic_paint_type WHERE (type_name='UV_painting')))), now(), null);
...
--VALUES(uuid_generate_v1(), (select id from formula.plastic_paint_type_color where paint_color_id = (select id from formula.plastic_paint_color where color_name = '彩色或高光(金/紅/藍)') and paint_type_id = (select id from formula.plastic_paint_type where type_name = 'UV_painting')), (select id  from formula.plastic_paint_button_top where button_top_name ='面漆') , now(), null);
--INSERT INTO formula.plastic_paint_type_color_button_top (paint_button_top_id, paint_type_color_id, create_time, disable_time) VALUES ( (SELECT id FROM formula.plastic_paint_button_top WHERE (button_top_name = '面漆')), (SELECT id FROM formula.plastic_paint_type_color WHERE (paint_color_id = (SELECT id FROM formula.plastic_paint_color WHERE (color_name='N/A'))) AND (paint_type_id = (SELECT id FROM formula.plastic_paint_type WHERE (type_name='UV_painting')))), now(), null);
--INSERT INTO formula.plastic_paint_type_color_button_top (paint_button_top_id, paint_type_color_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_paint_button_top WHERE (button_top_name = '面漆')), (SELECT id FROM formula.plastic_paint_type_color WHERE (paint_color_id = (SELECT id FROM formula.plastic_paint_color WHERE (color_name='一般或霧面(黑/灰/銀)'))) AND (paint_type_id = (SELECT id FROM formula.plastic_paint_type WHERE (type_name='UV_painting')))), now(), null);
--INSERT INTO formula.plastic_paint_type_color_button_top (paint_button_top_id, paint_type_color_id, create_time, disable_time) VALUES ( (SELECT id FROM formula.plastic_paint_button_top WHERE (button_top_name = '面漆')), (SELECT id FROM formula.plastic_paint_type_color WHERE (paint_color_id = (SELECT id FROM formula.plastic_paint_color WHERE (color_name='N/A'))) AND (paint_type_id = (SELECT id FROM formula.plastic_paint_type WHERE (type_name='UV_painting')))), now(), null);

INSERT INTO formula.plastic_paint_vendor_type_color_button_top
(id, type_color_button_top_id, paint_vendor_id, create_time, disable_time)
VALUES(uuid_generate_v1(),
(select id from formula.plastic_paint_type_color_button_top where paint_button_top_id = (select id from formula.plastic_paint_button_top where button_top_name = '底漆')
...
(id, type_color_button_top_id, paint_vendor_id, create_time, disable_time)
VALUES(uuid_generate_v1(),
(select id from formula.plastic_paint_type_color_button_top where paint_button_top_id = (select id from formula.plastic_paint_button_top where button_top_name = '面漆')
 and paint_type_color_id = (select id from formula.plastic_paint_type_color where paint_color_id =(select id from formula.plastic_paint_color where color_name = 'N/A')
 and paint_type_id = (select id from formula.plastic_paint_type where type_name ='PU_painting')
 )
) ,
...
select ppt.type_name, ppc.color_name, ppbt.button_top_name, pptcbt.id as type_color_bt_id from formula.plastic_paint_type as ppt, formula.plastic_paint_button_top as ppbt, formula.plastic_paint_color as ppc,
formula.plastic_paint_type_color as pptc, formula.plastic_paint_type_color_button_top as pptcbt
where ppt.id = pptc.paint_type_id and ppc.id = pptc.paint_color_id and pptcbt.paint_type_color_id = pptc.id and pptcbt.paint_button_top_id = ppbt.id
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = 'Akzo'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '9.72', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '東端'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '8.05', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '協承昌'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '7.32', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '新政豐'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '8.24', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '台贏'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '8.63', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '皇冠'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '0', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '歐歷'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '13.16', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = 'Others'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '25', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = 'Akzo'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '22.75', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '東端'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '9.11', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '協承昌'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '7.96', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '新政豐'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '6.19', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '台贏'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '9.55', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '皇冠'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '7.16', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '歐歷'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '7.96', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = 'Others'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '35', 'number', 'plastic_paint_vendor_type_color_button_top', now());
--------------------------NCVM----
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = 'Akzo'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '9.72', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '東端'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '8.05', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '協承昌'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '7.32', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '新政豐'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '8.24', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '台贏'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '8.63', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '皇冠'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '0', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = '歐歷'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '13.16', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '底漆' and vendor_name = 'Others'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '25', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = 'Akzo'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '15.53', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '東端'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '8.6', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '協承昌'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '8.92', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '新政豐'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '8.24', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '台贏'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '9.08', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '皇冠'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '0', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '歐歷'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '13.16', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'PU_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = 'Others'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '30', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = 'Akzo'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '22.75', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '東端'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '13.85', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '協承昌'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '9.85', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '新政豐'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '14.04', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '台贏'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '18.47', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '皇冠'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '15.98', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '歐歷'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '15.9', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'Rubber_painting' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = 'Others'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '35', 'number', 'plastic_paint_vendor_type_color_button_top', now());
--------------------------NCVM----
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = 'Akzo'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '15.53', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '東端'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '8.6', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '協承昌'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '8.92', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '新政豐'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '8.24', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '台贏'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '9.08', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '皇冠'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '0', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = '歐歷'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '13.16', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'NCVM' and color_name = 'N/A' and button_top_name = '面漆' and vendor_name = 'Others'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '30', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'UV_painting' and color_name = '一般或霧面(黑/灰/銀)' and button_top_name = '面漆' and vendor_name = 'Akzo'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '11.2', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'UV_painting' and color_name = '一般或霧面(黑/灰/銀)' and button_top_name = '面漆' and vendor_name = '歐歷'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '11.69', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'UV_painting' and color_name = '彩色或高光(金/紅/藍)' and button_top_name = '面漆' and vendor_name = 'Akzo'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '23.47', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'UV_painting' and color_name = '彩色或高光(金/紅/藍)' and button_top_name = '面漆' and vendor_name = '歐歷'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '14.03', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'UV_painting' and color_name = 'Soft Touch' and button_top_name = '面漆' and vendor_name = 'Akzo'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '17.89', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
left join formula.plastic_paint_vendor_type_color_button_top as ppvtcbt on ppvtcbt.paint_vendor_id = c.vendor_id and ppvtcbt.type_color_button_top_id = c.type_color_bt_id
left join formula.parameter_value pv on pv.parameter_id = ppvtcbt.id
where type_name = 'UV_painting' and color_name = 'Soft Touch' and button_top_name = '面漆' and vendor_name = '歐歷'
)
, (select id from formula.schedule_date where name = 'housing_plastic_init'), '17.52', 'number', 'plastic_paint_vendor_type_color_button_top', now());
...
INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.common_parameter WHERE (part_type = 'housing_plastic_management_and_profit') AND (label='management_and_profit')), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name='housing_plastic' )) )), '0.15', 'number', 'common_parameter', now());
 ...
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.common_parameter WHERE (part_type = 'housing_plastic_secondary_processing') AND (label='cnc_remove_area_cost')), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name='housing_plastic' )) )), '0.065', 'number', 'common_parameter', now());
 ...
 INSERT INTO formula.site (site_name, create_time, remark) VALUES ('WCD', now(), NULL);
  ...
  -- plastic_emi_group
 INSERT INTO formula.plastic_emi_group(id, group_name, remark, create_time, disable_time)VALUES(uuid_generate_v1(), '1', NULL, now(), null);
 INSERT INTO formula.plastic_emi_group(id, group_name, remark, create_time, disable_time)VALUES(uuid_generate_v1(), '2', NULL, now(), null);


 --site group
INSERT INTO formula.plastic_emi_site_group (group_id, site_id, remark, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name = '1')), (SELECT id FROM formula.site WHERE (site_name = 'WKS')), NULL, now(), null);
 INSERT INTO formula.plastic_emi_site_group (group_id, site_id, remark, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name = '1')), (SELECT id FROM formula.site WHERE (site_name = 'WZS')), NULL, now(), null);
 INSERT INTO formula.plastic_emi_site_group (group_id, site_id, remark, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name = '2')), (SELECT id FROM formula.site WHERE (site_name = 'WCQ')), NULL, now(), null);
 INSERT INTO formula.plastic_emi_site_group (group_id, site_id, remark, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name = '2')), (SELECT id FROM formula.site WHERE (site_name = 'WCD')), NULL, now(), null);

--emi size
 INSERT INTO formula.plastic_emi_sputtering_size (id, emi_size, remark, disable_time) VALUES (uuid_generate_v1(), 'N/A', NULL, null);
 INSERT INTO formula.plastic_emi_sputtering_size (id, emi_size, remark, disable_time) VALUES (uuid_generate_v1(), '10"', NULL, null);
 INSERT INTO formula.plastic_emi_sputtering_size (id, emi_size, remark, disable_time) VALUES (uuid_generate_v1(), '11"', NULL, null);
 INSERT INTO formula.plastic_emi_sputtering_size (id, emi_size, remark, disable_time) VALUES (uuid_generate_v1(), '12"', NULL, null);
 INSERT INTO formula.plastic_emi_sputtering_size (id, emi_size, remark, disable_time) VALUES (uuid_generate_v1(), '13"', NULL, null);
 INSERT INTO formula.plastic_emi_sputtering_size (id, emi_size, remark, disable_time) VALUES (uuid_generate_v1(), '14"', NULL, null);
 INSERT INTO formula.plastic_emi_sputtering_size (id, emi_size, remark, disable_time) VALUES (uuid_generate_v1(), '15"', NULL, null);
 INSERT INTO formula.plastic_emi_sputtering_size (id, emi_size, remark, disable_time) VALUES (uuid_generate_v1(), '16"', NULL, null);
 INSERT INTO formula.plastic_emi_sputtering_size (id, emi_size, remark, disable_time) VALUES (uuid_generate_v1(), '17"', NULL, null);
...
--plastic_emi_sputtering_link
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = 'N/A')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '10"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '11"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '12"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '13"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '14"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '15"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '16"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '17"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = 'N/A')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '10"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '11"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '12"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '13"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '14"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '15"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '16"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '17"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = 'N/A')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '10"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '11"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '12"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')), now(), null);
 ...
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '16"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '17"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = 'N/A')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '10"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '11"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '12"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '13"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '14"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '15"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '16"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '17"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = 'N/A')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '10"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '11"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '12"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '13"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '14"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '15"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '16"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '17"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = 'N/A')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '10"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '11"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')), now(), null);
 INSERT INTO formula.plastic_emi_sputtering_link (group_id, size_id, base_id, create_time, disable_time) VALUES ((SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' )), (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '12"')), (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')), now(), null);
 ...
 --paramater value
  INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '10"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.2700', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '11"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.2700', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '12"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3500', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '13"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3500', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '14"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4200', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '15"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4400', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '16"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4400', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '17"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.5800', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '10"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3000', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '11"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3000', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '12"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3800', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '13"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3800', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '14"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4200', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '15"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4400', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '16"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4400', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '17"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.5800', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '10"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3000', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '11"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3000', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '12"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3800', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '13"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3800', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '14"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4700', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '15"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.5300', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '16"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.5300', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '1' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '17"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.6300', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '10"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3500', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '11"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3500', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '12"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3900', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '13"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3900', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '14"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4300', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '15"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4600', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '16"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4600', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '17"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+ABS')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.5800', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '10"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3500', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '11"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3500', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '12"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3900', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '13"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3900', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '14"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4300', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '15"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4600', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '16"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4600', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '17"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF≦25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.5800', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '10"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3500', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '11"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3500', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '12"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3900', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '13"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.3900', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '14"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.4700', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '15"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.5300', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '16"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.5300', 'number', 'plastic_emi_sputtering_link', now());
 INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.plastic_emi_sputtering_link WHERE (group_id = (SELECT id FROM formula.plastic_emi_group WHERE (group_name= '2' ) AND (size_id = (SELECT id FROM formula.plastic_emi_sputtering_size WHERE (emi_size = '17"') AND (base_id = (SELECT id FROM formula.plastic_emi_sputtering_base WHERE (emi_base = 'PC+GF>25%')))))))), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_plastic' )) )), '0.6300', 'number', 'plastic_emi_sputtering_link', now());
...
INSERT INTO formula.parameter_value
(parameter_id, activate_date_id, value, value_type, source_table, create_time)
VALUES((select usd_min from formula.plastic_paint_info where product_type_id = (select id from formula.product_type where type_name = 'NB' )), (select id from formula.schedule_date where name = 'housing_plastic_init'), '0.55', 'number', 'plastic_paint_info', now());
INSERT INTO formula.parameter_value
(parameter_id, activate_date_id, value, value_type, source_table, create_time)
...
(id, grinding_name, lost_rate, total_cost, create_time, disable_time)
VALUES(uuid_generate_v1(), '自動+手工', uuid_generate_v1(), uuid_generate_v1(), now(), null);

INSERT INTO formula.parameter_value
(parameter_id, activate_date_id, value, value_type, source_table, create_time)
VALUES((select lost_rate from formula.plastic_grinding where grinding_name ='自動+手工') ,
(select id from formula.schedule_date where name = 'housing_plastic_init') , '0', 'number', 'plastic_grinding', now());

INSERT INTO formula.parameter_value
(parameter_id, activate_date_id, value, value_type, source_table, create_time)
VALUES((select total_cost from formula.plastic_grinding where grinding_name ='自動+手工') ,
...
INSERT INTO formula.plastic_printing (id, printing_name, loss_rate, unit_price, create_time, disable_time) values
(uuid_generate_v1(), '網印', uuid_generate_v1(), uuid_generate_v1(), now(), null),
(uuid_generate_v1(), '移印', uuid_generate_v1(), uuid_generate_v1(), now(), null),
(uuid_generate_v1(), '套印', uuid_generate_v1(), uuid_generate_v1(), now(), null);

INSERT INTO formula.plastic_embed_nail (id, embed_nail_name, loss_rate, unit_price, create_time, disable_time) values
(uuid_generate_v1(), '人工', uuid_generate_v1(), uuid_generate_v1(), now(), null),
(uuid_generate_v1(), '自動', uuid_generate_v1(), uuid_generate_v1(), now(), null);
...
((SELECT loss_rate FROM formula.plastic_printing WHERE printing_name='網印'), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name='housing_plastic' )) )), '0', 'number', 'plastic_printing', now()),
...
((SELECT loss_rate FROM formula.plastic_printing WHERE printing_name='移印'), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name='housing_plastic' )) )), '0', 'number', 'plastic_printing', now()),
...
((SELECT loss_rate FROM formula.plastic_printing WHERE printing_name='套印'), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name='housing_plastic' )) )), '0', 'number', 'plastic_printing', now()),
...
((SELECT loss_rate FROM formula.plastic_embed_nail WHERE embed_nail_name='人工'), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name='housing_plastic' )) )), '0', 'number', 'plastic_embed_nail', now()),
...
((SELECT loss_rate FROM formula.plastic_embed_nail WHERE embed_nail_name='自動'), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name='housing_plastic' )) )), '0', 'number', 'plastic_embed_nail', now());
...
(id, formula_type_id, part_type, sub_type, "label", unit, label_name, remark, system_remark, create_time)
VALUES(uuid_generate_v1(), (select id from  formula.formula_type where name='common'), 'material_loss_rate', null, 'material_AL_loss_rate', '%', 'AL Material loss rate',
'', '材料費_material_loss_rate', now());

INSERT INTO formula.common_parameter
(id, formula_type_id, part_type, sub_type, "label", unit, label_name, remark, system_remark, create_time)
VALUES(uuid_generate_v1(), (select id from  formula.formula_type where name='common'), 'material_loss_rate', null, 'material_Metal_loss_rate', '%', 'Metal Material loss rate',
'', '材料費_material_loss_rate', now());

INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.common_parameter WHERE (part_type = 'material_loss_rate') AND (label='material_AL_loss_rate')), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_metal' )) and name='housing_metal_init' )), '0.15', 'number', 'common_parameter', now());
INSERT INTO formula.parameter_value (parameter_id, activate_date_id, value, value_type, source_table, create_time) VALUES ((SELECT id FROM formula.common_parameter WHERE (part_type = 'material_loss_rate') AND (label='material_Metal_loss_rate')), (SELECT id FROM formula.schedule_date WHERE (formula_type_id= (SELECT id FROM formula.formula_type WHERE (name= 'housing_metal' )) and name='housing_metal_init' )), '0.05', 'number', 'common_parameter', now());
