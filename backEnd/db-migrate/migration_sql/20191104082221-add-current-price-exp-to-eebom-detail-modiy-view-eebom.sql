ALTER TABLE wiprocurement.eebom_detail ADD COLUMN IF NOT EXISTS current_price_exp varchar(2);
    ...
    eebom_detail.ce_cost,
        CASE
            ...
            WHEN (eebom_detail.supply_type::text = 'W'::text OR eebom_detail.supply_type::text = 'AV'::text OR eebom_detail.supply_type::text = 'S'::text OR eebom_detail.supply_type IS NULL) AND eebom_detail.current_price IS NOT NULL THEN
              LEAST(eebom_detail.current_price, eebom_detail.spa, eebom_detail.lpp, eebom_detail.alt_lowest_price)
            WHEN (eebom_detail.supply_type::text = 'W'::text OR eebom_detail.supply_type::text = 'AV'::text OR eebom_detail.supply_type::text = 'S'::text OR eebom_detail.supply_type IS NULL) AND eebom_detail.sourcer_cost IS NOT NULL THEN
              LEAST(eebom_detail.sourcer_cost, eebom_detail.spa, eebom_detail.lpp, eebom_detail.alt_lowest_price)
        ...
        CASE
            ...
            WHEN (eebom_detail.supply_type::text = 'W'::text OR eebom_detail.supply_type::text = 'AV'::text OR eebom_detail.supply_type::text = 'S'::text OR eebom_detail.supply_type IS null) AND eebom_detail.current_price IS NOT NULL THEN
              LEAST(eebom_detail.current_price, eebom_detail.spa, eebom_detail.lpp, eebom_detail.alt_lowest_price) * eebom_detail.qty
            WHEN (eebom_detail.supply_type::text = 'W'::text OR eebom_detail.supply_type::text = 'AV'::text OR eebom_detail.supply_type::text = 'S'::text OR eebom_detail.supply_type IS null) AND eebom_detail.sourcer_cost IS NOT NULL THEN
              LEAST(eebom_detail.sourcer_cost, eebom_detail.spa, eebom_detail.lpp, eebom_detail.alt_lowest_price) * eebom_detail.qty
