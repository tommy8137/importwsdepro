...
ALTER TABLE wiprocurement.sapalt_price
  ADD COLUMN if NOT EXISTS alt_num_without_main_pn varchar(20),
  ADD COLUMN if NOT EXISTS lowest_price_without_main_pn numeric,
  ADD COLUMN if NOT EXISTS manufacturer_without_main_pn varchar(50),
  ADD COLUMN if NOT EXISTS origin_lowest_price_without_main_pn numeric,
  ADD COLUMN if NOT EXISTS currency_without_main_pn varchar(20),
  ADD COLUMN if NOT EXISTS origin_currency_without_main_pn varchar(20),
  ADD COLUMN if NOT EXISTS valid_from_without_main_pn date,
  ADD COLUMN if NOT EXISTS similar_info_without_main_pn JSON;


ALTER TABLE wiprocurement.eebom_detail
  ADD COLUMN IF NOT EXISTS alt_lowest_price_without_main_pn numeric,
  ADD COLUMN IF NOT EXISTS alt_lowest_partnumber_without_main_pn varchar(20),
  ADD COLUMN IF NOT EXISTS alt_manufacturer_without_main_pn varchar(50),
  ADD COLUMN IF NOT EXISTS alt_other_info_without_main_pn JSON,

  ADD COLUMN IF NOT EXISTS avl_alt_without_main_pn numeric,
  ADD COLUMN IF NOT EXISTS avl_alt_other_info_without_main_pn JSON,
  ADD COLUMN IF NOT EXISTS avl_alt_bolder_without_main_pn Boolean DEFAULT false;
...
AS SELECT eebom_detail.id,
    ...
    eebom_detail.board,
    eebom_detail.eedm_description,
    eebom_detail.reference,
    eebom_detail.avap,
    eebom_detail.supply_type_diff,
    eebom_detail.supply_type_list,
    eebom_detail.alt_lowest_price_without_main_pn,
    eebom_detail.alt_lowest_partnumber_without_main_pn,
    eebom_detail.alt_manufacturer_without_main_pn,
    eebom_detail.alt_other_info_without_main_pn,
    eebom_detail.avl_alt_without_main_pn,
    eebom_detail.avl_alt_other_info_without_main_pn,
    eebom_detail.avl_alt_bolder_without_main_pn
