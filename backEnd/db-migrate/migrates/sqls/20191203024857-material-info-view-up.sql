...
SELECT a.part_cate1_id as part_category_1_id,
    a.part_cate1_name as part_category1_name,
    a.part_cate2_id as part_category_2_id,
    a.part_cate2_name as part_category2_name,
    a.material_spec_id,
   ...
   FROM ( SELECT b.part_cate1_id,
           ...
           FROM ( SELECT part_category_material.part_category_2_id,
                  ...
                  WHERE part_category_material.disable_time IS NULL) a_1
             JOIN ( SELECT a_2.id AS part_cate1_id,
                   ...
                   FROM ( SELECT part_category_1.id,
                          ...
                          WHERE part_category_1.disable_time IS NULL) a_2
                     JOIN ( SELECT part_category_2.id,
                          ...
                          WHERE part_category_2.disable_time IS NULL) b_1 ON a_2.id = b_1.part_category_1_id) b ON a_1.part_category_2_id = b.part_cate2_id
             ...
             JOIN ( SELECT a_2.id AS part_cate1_id,
                   ...
                   FROM ( SELECT part_category_1.id,
                     ...
                     JOIN ( SELECT part_category_2.id,
                            ...
                            part_category_2.disable_time
                           FROM formula.part_category_2
                          WHERE part_category_2.disable_time IS NULL) b_1 ON a_2.id = b_1.part_category_1_id) c ON a_1.part_category_2_id = c.part_cate2_id
        UNION ALL
         SELECT b.part_cate1_id,
            ...
            NULL::character varying AS material_sepc_name,
            null as material_spec_disable_time,
            c.id AS material_id,
            c.name AS material_name,
            c.disable_time as material_disable_time
             ...
             JOIN ( SELECT a_2.id AS part_cate1_id,
                   ...
                   FROM ( SELECT part_category_1.id,
                     ...
                     JOIN ( SELECT part_category_2.id,
                            ...
                            part_category_2.disable_time
                           FROM formula.part_category_2
                          WHERE part_category_2.disable_time IS NULL) b_1 ON a_2.id = b_1.part_category_1_id) b ON a_1.pategory_category_2_id = b.part_cate2_id
        ...
        UNION ALL
         SELECT b.part_cate1_id,
            ...
            a_1.material_name AS material_name,
            a_1.disable_time as material_disable_time
        ...
        UNION ALL
         SELECT c.part_cate1_id,
            ...
            c.part_cate2_name,
            a_1.id AS material_spec_id,
            a_1.spec_name AS material_spec_name,
            a_1.disable_time as material_spec_disable_time,
            b.id AS material_id,
            b.material_name,
            b.disable_time as material_disable_time
             ...
             JOIN ( SELECT a_2.id AS part_cate1_id,
                   ...
                   FROM ( SELECT part_category_1.id,
                     ...
                     JOIN ( SELECT part_category_2.id,
                            ...
                            part_category_2.disable_time
                           FROM formula.part_category_2
                          WHERE part_category_2.disable_time IS NULL) b_1 ON a_2.id = b_1.part_category_1_id) b ON a_1.part_category_2_id = b.part_cate2_id) a
order by part_cate1_name, part_cate2_name;
