...
CREATE TABLE IF NOT EXISTS wiprocurement.eedm_pn_lowest_price (
  ...
  CONSTRAINT eedm_pn_lowest_price_pkey PRIMARY KEY (partnumber, purchaseorg)
);

CREATE TABLE IF NOT EXISTS wiprocurement.eedm_pn_2nd_highest_price (
  partnumber varchar NOT NULL,
  purchaseorg varchar NOT NULL,
  mpnno varchar NULL,
  description varchar NULL,
  ...
  valid_from date NULL,
  currency_price numeric NULL,
  CONSTRAINT eedm_pn_2nd_highest_price_pkey PRIMARY KEY (partnumber, purchaseorg)
);

ALTER TABLE wiprocurement.eebom_detail
  ADD COLUMN if NOT EXISTS lowest_price numeric,
  ADD COLUMN if NOT EXISTS lowest_price_currency_price numeric,
  ADD COLUMN if NOT EXISTS lowest_price_currency varchar,
  ADD COLUMN if NOT EXISTS lowest_price_valid_from date,

  ADD COLUMN if NOT EXISTS second_highest_price numeric,
  ADD COLUMN if NOT EXISTS second_highest_price_currency_price numeric,
  ADD COLUMN if NOT EXISTS second_highest_price_currency varchar,
  ADD COLUMN if NOT EXISTS second_highest_price_valid_from date;
