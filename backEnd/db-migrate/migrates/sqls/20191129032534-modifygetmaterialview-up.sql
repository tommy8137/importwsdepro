...
AS SELECT a.part_cate1_id,
   ...
   FROM ( SELECT b.part_cate1_id,
            b.part_cate1_name,
            b.part_cate1_disable_time::varchar,
            b.part_cate2_id,
            b.part_cate2_name,
            b.part_cate2_disable_time::varchar,
            c.material_spec_id,
             ...
             JOIN ( SELECT a_2.id AS part_cate1_id,
                   ...
                   FROM ( SELECT part_category_1.id,
                     ...
                     JOIN ( SELECT part_category_2.id,
                          ...
                          ) b_1 ON a_2.id = b_1.part_category_1_id) b ON a_1.part_category_2_id = b.part_cate2_id
             JOIN ( SELECT a_2.id AS material_spec_id,
                    a_2.material_spec_name,
                    a_2.disable_time::varchar  as material_spec_disable_time,
                    b_1.id AS material_id,
                    b_1.material_name,
                    b_1.disable_time::varchar as material_disable_time
                   FROM ( SELECT material_spec.id,
                     ...
                     JOIN ( SELECT material.id,
                          ...
                          ) b_1 ON a_2.id = b_1.material_spec_id) c ON a_1.material_id = c.material_id
        UNION ALL
         SELECT c.part_cate1_id,
            ...
            a_1.disable_time::varchar as material_spec_disable_time,
            b.id AS material_id,
            b.material_name,
            b.disable_time::varchar as material_disable_time
           FROM formula.diecut_material_spec a_1
             JOIN ( SELECT diecut_material.id,
                  ...
                  ) b ON a_1.id = b.diecut_material_spec_id
             JOIN ( SELECT a_2.id AS part_cate1_id,
                    a_2.category_name AS part_cate1_name,
                    b_1.id AS part_cate2_id,
                    b_1.category_name AS part_cate2_name,
                   ...
                   FROM ( SELECT part_category_1.id,
                     ...
                     JOIN ( SELECT part_category_2.id,
                            ...
                            part_category_2.disable_time
                           FROM formula.part_category_2
                          ) b_1 ON a_2.id = b_1.part_category_1_id) c ON a_1.part_category_2_id = c.part_cate2_id
        UNION ALL
         SELECT b.part_cate1_id,
            ...
            c.disable_time::varchar as material_spec_disable_time,
            NULL::uuid AS material_id,
            NULL::character varying AS material_name,
            NULL::varchar  AS material_disable_time
             ...
             JOIN ( SELECT a_2.id AS part_cate1_id,
                   ...
                   FROM ( SELECT part_category_1.id,
                     ...
                     JOIN ( SELECT part_category_2.id,
                            ...
                            part_category_2.disable_time
                           FROM formula.part_category_2
                          ) b_1 ON a_2.id = b_1.part_category_1_id) b ON a_1.pategory_category_2_id = b.part_cate2_id
        ...
        UNION ALL
         SELECT c.part_cate1_id,
           ...
           FROM ( SELECT rubber_material_spec.id,
             ...
             JOIN ( SELECT rubber_material.id,
...
--set meother fill remark value is null						   
ALTER TABLE formula.parameter_value ALTER COLUMN value DROP NOT NULL;
update formula.parameter_value set value = null where parameter_id in (select material_id from formula.v_me_bom_materialspec_and_material_value where material_name ='Other_Fill_ME_Remark');
