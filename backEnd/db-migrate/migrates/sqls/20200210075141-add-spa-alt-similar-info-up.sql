ALTER TABLE wiprocurement.sapalt_price ADD COLUMN if NOT EXISTS similar_info JSON;
ALTER TABLE wiprocurement.eedm_spa_price ADD COLUMN if NOT EXISTS similar_info JSON;


ALTER TABLE wiprocurement.eebom_detail
  ADD COLUMN if NOT EXISTS avl_spa numeric,
  ADD COLUMN if NOT EXISTS avl_spa_other_info JSON,
  ADD COLUMN if NOT EXISTS avl_alt numeric,
  ADD COLUMN if NOT EXISTS avl_alt_other_info JSON;


ALTER TABLE wiprocurement.edm_version
  ADD COLUMN if NOT EXISTS avl BOOLEAN DEFAULT TRUE;
